...
<head>
    ...
    <link rel="stylesheet" href="{{$web_path}}css/font.css">
    <link rel="stylesheet" href="{{$web_path}}css/login.css">
	  <link rel="stylesheet" href="{{$web_path}}css/xadmin.css">
    <script type="text/javascript" src="https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
    <script src="{{$web_path}}lib/layui/layui.js" charset="utf-8"></script>
    <!--[if lt IE 9]>
